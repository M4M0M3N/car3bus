...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    #impostare page 1
        ...
        pixmap_1 = pixmap_1.scaled(int(pixmap_1.width() / ridimensiona), int(pixmap_1.height() / ridimensiona))
    ...
    #impostare page 2
        ...
        pixmap_2_s = pixmap_2_s.scaled(int(pixmap_2_s.width() / ridimensiona_s), int(pixmap_2_s.height() / ridimensiona_s))
        pixmap_2_l = pixmap_2_l.scaled(int(pixmap_2_l.width() / ridimensiona_l), int(pixmap_2_l.height() / ridimensiona_l))
